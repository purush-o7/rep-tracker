...
-- 6. Recommended set/rep scheme per exercise (tagline like "4 × 10–12")
UPDATE public.workouts w
SET default_sets = v.sets, default_reps = v.reps
FROM (VALUES
  ...
  ('Hyperextension (Back Extension)', 3, '15'),
  ...
  ('Sumo Deadlift', 4, '6–8'),
  ('Lateral Band Walk', 3, '15 each side'),
  ('Plank', 3, '45 sec'),
  ...
  ('Russian Twist', 3, '20 (10 each side)'),
  ('Dead Bug', 3, '10 each side'),
  ('Ab Wheel Rollout', 3, '10–12'),
  ('Cable Woodchopper', 3, '12 each side'),
  ('Mountain Climbers', 3, '30 sec'),
  ('Superman Hold', 3, '20'),
  ('Dumbbell Side Bend', 3, '15 each side'),
  ('Cable Crunch', 4, '15'),
  ('Wrist Curl', 3, '15'),
  ('Reverse Wrist Curl', 3, '15'),
  ('Reverse Curl', 3, '12–15'),
  ('Farmer''s Carry', 3, '30–40 steps'),
  ('Plate Pinch', 3, '30 sec'),
  ('Treadmill Run', NULL, '20–30 min'),
  ('Rowing Machine', NULL, '10–15 min'),
  ('Jump Rope', 3, '2 min'),
  ('Cycling', NULL, '20–30 min'),
  ('Stair Climber', NULL, '15–20 min'),
  ('Elliptical', NULL, '20–30 min'),
  ('Burpees', 3, '15'),
  ('High Knees', 3, '45 sec'),
  ('Jumping Jacks', 3, '50'),
  ('Box Jump', 4, '10'),
